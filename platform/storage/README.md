...
`medikong-aws-gp3` StorageClass는 EBS CSI provisioner(`ebs.csi.aws.com`)를 호출한다. 클러스터에는 AWS EBS CSI driver와 그 driver가 EBS volume을 만들 수 있는 IAM 권한이 먼저 준비되어 있어야 한다.
